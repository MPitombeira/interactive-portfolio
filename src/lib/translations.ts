export const translations = {
  en: {
    ...
    experienceText: "6 years studying and building web applications",
    goals: "Goals",
    goalsText: `Currently, I'm looking for opportunities where I can contribute to
  ...
  ptbr: {
    ...
    study: "Estudando",
    playlist: "Playlist Favorita",
    experienceText: "6 anos estudando e construindo aplicações web",
    goals: "Objetivo",
